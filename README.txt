...
- Ethiopia now starts united with 70% westernisation progress
- Southern France states reworked: The 3 border provinces with Spain belong to the new "Pyrenees" state, Le Midi state absorbed by Aquitaine
- Rebels don't give war exhaustion anymore
- All majority German provinces in Austria increased from 35 to 38 liferating
- Chance of new ships being invented exponentially increased
- Fuel needed for ship upkeep reduced by 75% to enable more competition in late game navy
- A decision that would crash the game as Egypt fixed (for all my Egypt mains)
