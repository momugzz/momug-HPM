...
diplomacy = {
    ...
    WAR_FAILED_GOAL_PRESTIGE_BASE = -25,
...
pops = {
    ...
    ASSIMILATION_SCALE = 0.025, -- original is 0.004
    ...
    MIL_TO_JOIN_REBEL = 7.5, -- Rebels over this will join a faction
    MIL_TO_JOIN_RISING = 8.5, -- Rebels over this will join a general rising
